...
var Day = React.createClass({
  ...
  render: function () {
    ...
    var displayDescription = this.props.dayData.map(function (item) {
      return React.createElement(TimeForecast, { item: item });
    });
    ...
    return React.createElement(
      'div',
      { className: 'col-md-15 col-sm-3 text-center', style: styleDayContainer },
      React.createElement(
        'h3',
        null,
        this.props.dayData[0].dt_txt.slice(0, 11)
      ),
      React.createElement(
        'h5',
        null,
        this.props.dayData[0].weather[0].description.toUpperCase()
      ),
      React.createElement(
        'div',
        { className: 'embed-responsive embed-responsive-4by3', loop: 'loop', autoplay: true },
        React.createElement('iframe', { style: videoStyle, className: 'embed-responsive-item', src: getVideo(this.props.dayData), loop: 'loop', Volume: '0' })
      ),
      displayDescription
    );
  }
...
},{"./TimeForecast.jsx":171,"react":167}],170:[function(require,module,exports){
var React = require('react');
var Day = require('./Day.jsx');
var HTTP = require('../services/httpservice');

var LocationManager = React.createClass({
  displayName: 'LocationManager',
  ...
  render: function () {
    ...
    if (this.state.data.list) {
      ...
      var callForecast = arrayOfDays.map(function (item, index) {
        return React.createElement(Day, { dayData: item });
      });
    }
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('img', { src: '../public/images/logo2.png', alt: '' })
        ),
        React.createElement(
          'div',
          { className: 'col-sm-4' },
          React.createElement(
            'div',
            { style: styleFrom, className: 'something text-center form-group' },
            React.createElement(
              'form',
              ...
              React.createElement(
                'div',
                { className: 'col-sm-8' },
                React.createElement('input', { style: inputStyle, type: 'text', className: 'form-control', placeholder: 'Type name of a city...', onChange: this.onChange, value: this.state.city })
              ),
              React.createElement(
                'div',
                { className: 'col-sm-4' },
      ...
      React.createElement(
        'div',
        { className: 'something text-center' },
        React.createElement(
          'h2',
          null,
          'Current Location: ',
...
},{"../services/httpservice":173,"./Day.jsx":169,"react":167}],171:[function(require,module,exports){
var React = require('react');

var TimeForecast = React.createClass({
  displayName: "TimeForecast",
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    "td",
                    null,
                    this.props.item.dt_txt.slice(11, 16)
                  ),
                  React.createElement(
                    "td",
                    null,
                    React.createElement("img", { src: getUrlIcon, alt: "" })
                  ),
                  React.createElement(
                    "td",
                    null,
                    Math.floor(this.props.item.main.temp - 273.15) + degrees[1] + "C"
                  )
                )
              )
            )
...
var LocationManager = require('./components/LocationManager.jsx');

ReactDOM.render(React.createElement(LocationManager, null), document.getElementById('weather'));

},{"./components/LocationManager.jsx":170,"react":167,"react-dom":29}],173:[function(require,module,exports){
